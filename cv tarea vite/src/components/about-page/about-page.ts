import './about-education/about-education.js';
import './about-expierence/about-experience.js';
import './about-skills/about-skills.js';
import './about-hobbies/about-hobbies.js';
...
class AboutPage extends HTMLElement {
  ...
  #loadSection(tag: any) {
    ...
    this.querySelector(map[tag])!.classList.add('active');
  }
